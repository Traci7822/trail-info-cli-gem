...
class TrailInfo::UserInteraction
  ...
  def self.list_trails
    if @state_number.between?(1, 51)
      puts "You've selected #{@state_number}. #{@@STATE_NAMES.values[@state_number - 1]}. Here are the available trails in #{@@STATE_NAMES.values[@state_number - 1]} according to TrailLink.com. This may take a moment to load.\n \n"
      initiate_state
